...
export const getStreetView = (lat, lng) => {
     let url = `https://maps.googleapis.com/maps/api/streetview?size=400x400&location=` + lat + `,` + lng + `&fov=90&heading=90&pitch=0&key=AIzaSyCXprUHPvRyqaLjZ27B5ZS1tu8tclJ_wVQ`
     return url
}
